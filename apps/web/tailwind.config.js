  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        /* Every semantic colour carries `<alpha-value>` too. Without it an
           opacity modifier (`bg-foreground/90`, `text-muted-foreground/70`) is
           dropped silently at build time — the class simply never appears in
           the stylesheet, and the element renders at full strength with no
